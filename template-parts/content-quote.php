...
<div id="post-<?php the_ID(); ?>" class="col-md-12 col-sm-12 col-xs-12 col-xxs-12 cb "> 
    <div class="blog-post"> 
      <?php $post_quote = get_post_meta(get_the_ID(), '_lessons_post_quote', true); ?>
      <?php if(!empty($post_quote)): ?>
        <div class="blog-post__image-wrap wpx-quote">
          <blockquote class="dark-bg post-quote quote-card"> <?php echo sprintf( __('<p>%s</p>','lessons'),$post_quote ); ?></blockquote> 
        </div>
      <?php else: ?> 
