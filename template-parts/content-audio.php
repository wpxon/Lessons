...
<div id="post-<?php the_ID(); ?>" class="col-md-12 col-sm-12 col-xs-12 col-xxs-12 cb "> 
    <div class="blog-post">
          <?php  $lessons_audio = get_post_meta(get_the_ID(),'_lessons_post_audio',true);    ?>
            <?php if(!empty($lessons_audio)): ?>  
              <div class="blog-post__image-wrap">
                <div class="soundcloud">
                  <iframe width="100%" height="166" scrolling="no" frameborder="no" src="https://w.soundcloud.com/player/?url=<?php echo esc_url($lessons_audio); ?>"></iframe>
                </div> 
              </div>  
          <?php else: ?> 
